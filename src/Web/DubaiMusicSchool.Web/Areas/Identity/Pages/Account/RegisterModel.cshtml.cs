namespace DubaiMusicSchool.Web.Areas.Identity.Pages.Account
{
    using System;
    ...
    {
        private readonly SignInManager<SchoolAppUser> signInManager;
        ...
        public class InputModel
        {
            ...
            [StringLength(GlobalConstants.PersonNameMaxLength, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.", MinimumLength = 2)]
